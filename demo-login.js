        ...
        <header class="finance-demo-dashboard-header">
          ...
          <div class="finance-demo-topbar">
            ...
            <label class="finance-demo-search">
              ...
              <input type="search" placeholder="How can we help you?" autocomplete="off">
              ${icon("search")}
            </label>
        ...
        <main class="finance-demo-main" tabindex="-1">
          ...
          <section class="finance-demo-column finance-demo-column--activity" aria-label="Demo account activity">
            ...
            <article class="finance-demo-card finance-demo-spending-card">
              ...
              <div class="finance-demo-spending-content">
                <div class="finance-demo-spending-total"><b>$3,158.48</b><span>Total Spending</span><small>as of May 23, 2026</small></div>
                <svg class="finance-demo-donut" viewBox="0 0 42 42" role="img" aria-label="Fictional spending chart">
                  ...
                  <circle class="finance-demo-donut-segment finance-demo-donut-segment--housing" cx="21" cy="21" r="15.9" pathLength="100" stroke-dasharray="45.9 54.1" stroke-dashoffset="25"></circle>
                  <circle class="finance-demo-donut-segment finance-demo-donut-segment--transportation" cx="21" cy="21" r="15.9" pathLength="100" stroke-dasharray="21.5 78.5" stroke-dashoffset="-20.9"></circle>
                  <circle class="finance-demo-donut-segment finance-demo-donut-segment--food" cx="21" cy="21" r="15.9" pathLength="100" stroke-dasharray="16.5 83.5" stroke-dashoffset="-42.4"></circle>
                  <circle class="finance-demo-donut-segment finance-demo-donut-segment--shopping" cx="21" cy="21" r="15.9" pathLength="100" stroke-dasharray="9.8 90.2" stroke-dashoffset="-58.9"></circle>
                  <circle class="finance-demo-donut-segment finance-demo-donut-segment--entertainment" cx="21" cy="21" r="15.9" pathLength="100" stroke-dasharray="6.3 93.7" stroke-dashoffset="-68.7"></circle>
                </svg>
                <ul class="finance-demo-chart-legend">
                  <li><i class="legend-housing"></i><span>Housing</span><b>$1,450.00</b></li>
                  <li><i class="legend-transportation"></i><span>Transportation</span><b>$680.00</b></li>
                  <li><i class="legend-food"></i><span>Food &amp; Dining</span><b>$520.00</b></li>
                  <li><i class="legend-shopping"></i><span>Shopping</span><b>$310.00</b></li>
                  <li><i class="legend-entertainment"></i><span>Entertainment</span><b>$198.48</b></li>
                  <li><i class="legend-other"></i><span>Other</span><b>$0.00</b></li>
                </ul>
              </div>
            </article>
          ...
          <aside class="finance-demo-column finance-demo-column--support" aria-label="Demo help and offers">
            <article class="finance-demo-card finance-demo-help-card">
              ...
              <div class="finance-demo-support-body">
                <div>
                  <p><strong>Demo Support is here to help.</strong></p>
                  <p>Get personalized demo assistance.</p>
              ...
              <div class="finance-demo-security-panel">
                ...
                <button class="finance-demo-text-action" type="button" data-finance-inert>View Demo Security</button>
              </div>
            </article>
